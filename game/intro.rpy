label intro:
    scene black
    with fade
    "You, a standard college student, are inside a convenience store buying food."
    ...
    with fade 
    mc "(It takes some time for me to recover. My body isn't as badly injured as it appeared to be, but it still took some time. About two months, actually. Soon enough I'll be able to walk again, and after that I could go back to how I used to be, minus the memories. I tried my best to feel something in my heart. Books that would inspire even the most hopeless of individuals would only make me more willing to turn around in bed. Movies that would turn stoics into sobbing messes can force less tears out of my eyes than a yawn.)"
    ...
    mc "(Something strange happened after this checkpoint in my recovery. My back started tingling, my legs started getting sore. But most importantly of all, my head started to ache. It was like my brain had expanded 3 sizes, but my skull didn't catch up. I felt an odd pressure against the front and back of my head.)"
    ...
    mc "(I begin to relax my body. I start to pull the covers back over my body. Their warmth comforts me, yearning for my return. It feels so calming, that in this world of uncertainty, there is at least something that will accept me.)"
    ...
    mc "(Hmmm…)"
    "Knocking"
    mc "(The nurse is here for her mid-day visit…)"
    "The door opens"
    ...
    mc "Fine."
    "Nurse" "That's good."
    mc "(~Winces mentally~ That was an awful conversation. I should've said more.)"
    ...
    mc "(WHAT?)"
    mc "(She hands me a stapled list of papers containing all the expenses of my recovery.)"
    ...
    mc "(Unfortunately it is. Printed right at the bottom is a six-digit number, long as a phone number, well into the four hundred thousand. Ambulance, medical supplies, surgeries, all merge forces to put me $458 thousand in debt.)"
    "Nurse" "Yeah it's a lavishing bill."
    ...
    mc "(Again, hospitals like to save money due to the expensive equipment. None of it is anything I can keep. I did borrow a few books from the library they have here, but only patients have the right to borrow them. Maybe I could ask for some of the coloring materials they give the children? They get used up every few weeks, so it's not like they're completely permanent. I don't need half-used crayons and colored pencils though, so I'd rather not do that.)"
    ...
    mc "(He continues to analyze me like a shark circling its prey. His aggressive eyes stare me down, missing not even a single hair on my body. Every fold of my skin, every pattern in my movements, every slight twitch of a muscle. Nothing seems to escape his sight.)"
